<?php
   ...
   require_once( __CLS_PATH . "cls_remdatabase.php");
	...
	class cls_New {
      ...
      public function insert_newdata($sectiondata = array()){
			...
			$result=$this->data_provide->sql_execute("INSERT INTO tbl_news
														   (new_title,
															...
															VALUES ('" . $newdata[1] . "','" . $newdata[2] . "','" . $newdata[3] . "',
															        ...
															        '" . $newdata[7] . "','" . $newdata[8] . "','" . date('Y-m-d H:i:s') . "',
                                                                    '" . date('Y-m-d H:i:s') . "')");
			if($result){
				$success=true;
			}
      ...
      public function update_sectiondata($newdata = array(),$id_new){
