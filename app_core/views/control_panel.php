    ...
    <script>
	  ...
	  <div id="db_selector">
        <?php 
            ...
            echo "<span>Conectar con: </span>";
            echo cls_HTML::html_link_tag("BD: Sitio de Prueba", "btn_ucreasite_test", "ext_button", "?username=" . $row[0][1] . "&db=2", "", "Conectar con Sitio de prueba", "");
            echo cls_HTML::html_link_tag("BD: Sitio Web", "btn_ucreasite", "ext_button", "?username=" . $row[0][1] . "&db=1", "", "Conectar con Sitio de la Universidad", "");
            echo "<span>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>";
            echo cls_HTML::html_link_tag("Ver ucreativa.com", "web_real", "ext_button", "http://www.ucreativa.com/ucreasite/", "_blank", "Sitio de la Universidad", "");
            echo cls_HTML::html_link_tag("Ver ucreasite_test", "web_test", "ext_button", "http://www.ucreativa.com/ucreasite_test/", "_blank", "Sitio de Prueba", "");
