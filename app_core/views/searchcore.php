                ...
                foreach($data_set as $dataset){
                        ...
                        while($a < count($dataset)){
                            if($a==0){ ?>
                               ...
                               <td><a target="_parent" href="<?php echo __VWS_HOST_PATH . 'fileupload.php'; ?>?id=<?php echo $dataset[0]; ?>&edit=1&return=<?php echo $_GET['path']; ?>&form=<?php echo $_GET['form']; ?>" title="Administrar Archivos"><?php echo cls_HTML::html_img_tag(__IMG_PATH . "folder.png" , "", "r_icon", "file", "WIDTH=24"); ?></a></td>
